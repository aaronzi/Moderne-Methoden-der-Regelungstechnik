...
% Include TEX-Files (Performance beim Testen)
% \includeonly{8_beobachter}
...
\include{3_nichtlinear_zustandsraummodell}

\include{4_linear_zustandsraummodell}

\include{5_vergleich}

\include{6_zustandsreglerentwurf}

\include{7_reglervalidierung}

\include{8_beobachter}

...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.65\textwidth]{Bilder/Phi_rad_Vergleich.pdf}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.65\textwidth]{Bilder/Phi_Grad_Vergleich.pdf}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1.0\textwidth]{Bilder/Phi_Grad_Vergleich_Verschiebung.pdf}}

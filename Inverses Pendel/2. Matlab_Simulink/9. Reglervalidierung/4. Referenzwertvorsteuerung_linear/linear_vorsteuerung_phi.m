function linear_vorsteuerung_phi()
    warning('off','all')
    ...
    for i=1:5
        ...
        for j=1:6
            ...
            simOut = sim('Zustandsregelung_mit_Vorsteuerung_linear','StartTime','0','StopTime','2.5','FixedStep','1/1e4');
    ...
    filename = fullfile('./9. Reglervalidierung/4. Referenzwertvorsteuerung_linear/', 'linear_vorsteuerung_phi.pdf');

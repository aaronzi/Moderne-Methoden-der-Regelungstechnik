function linear_i_regler_u()
    ...
    for i=1:5
        ...
        for j=1:6
            ...
            simOut = sim('Zustandsregelung_mit_Vorsteuerung_linear','StartTime','0','StopTime','3.5','FixedStep','1/1e4');
            u = simOut.u.Data;
            t_vec = simOut.tout;
            plot(t_vec,u)
            hold on
    ...
    filename = fullfile('./9. Reglervalidierung/6. I-Regelung_linear/', 'linear_i_regler_u.pdf');

function linear_i_regler_phi()
    ...
    for i=1:5
        ...
        for j=1:6
            ...
            simOut = sim('Zustandsregelung_mit_I_Regelung_linear','StartTime','0','StopTime','3.5','FixedStep','1/1e4');
    ...
    filename = fullfile('./9. Reglervalidierung/6. I-Regelung_linear/', 'linear_i_regler_phi.pdf');

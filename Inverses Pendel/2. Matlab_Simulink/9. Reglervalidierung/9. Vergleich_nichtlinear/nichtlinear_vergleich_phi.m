function nichtlinear_vergleich_phi()
    warning('off','all')
    % sP_Acker = [-4 -4 -4 -4];
    ...
    filename = fullfile('./9. Reglervalidierung/9. Vergleich_nichtlinear/', 'nichtlinear_vergleich_phi.pdf');

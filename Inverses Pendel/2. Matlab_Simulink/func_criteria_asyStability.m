%--------------------------------------------------------------------------------
% func_criteria_asyStability      14.6.2021
%--------------------------------------------------------------------------------
% Matlab function for solving LMI for proving aymptotic stability 
%--------------------------------------------------------------------------------
function Psol = func_criteria_asyStability(A)
...
% with TERMID(1) = -n  ->  right-hand side of the n-th L

% Block structure with one LMI 
%lmiterm([1 1 1 P],1,A,'s');      % A'P + PA  < 0 
%lmiterm([1 1 2 0],1);            % 0
%lmiterm([1 2 2 P],-1,1);         % P > 0

% no Block structure with two LMIs

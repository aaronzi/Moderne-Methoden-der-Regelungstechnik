...
% Beschreibung Duty Cycle d und Berechnung (d = v_DC / v_PV)    X
% Angabe der Schaltfrequenz f_sw (s. Schaltbild -> 50kHz)       X
% Angabe Gleichspannung v_DC = 900V                             X
% Angabe der Annahmen:                                          X
        % S = 1000W/m^2
        % T_c = 298K (25°C)
...
function nichtlinear_einfache_rueckfuehrung()
    warning('off','all')

    % PFAD DER SIMULATION V_PV
    simOut = sim('Einfache_Zustandsrueckfuehrung_nichtlinear','StartTime','0','StopTime','10','FixedStep','1/1e5');
    ...
    filename = fullfile('./7. Reglervalidierung/3. Einfache_Zustandsrueckfuehrung_nichtlinear/', 'nichtlinear_einfache_rueckfuehrung.pdf');

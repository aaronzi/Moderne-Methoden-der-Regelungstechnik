...
function linear_referenzwertvorsteuerung()
    warning('off','all')

    % PFAD DER SIMULATION V_PV
    simOut = sim('Zustandsregelung_mit_Vorsteuerung_linear','StartTime','0','StopTime','10','FixedStep','1/1e4');
    ...
    filename = fullfile('./7. Reglervalidierung/4. Zustandsregelung_mit_Vorsteuerung_linear/', 'linear_referenzwertvorsteuerung.pdf');

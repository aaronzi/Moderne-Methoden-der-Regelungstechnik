...
function nichtlinear_referenzwertvorsteuerung()
    warning('off','all')

    % PFAD DER SIMULATION V_PV
    simOut = sim('Zustandsregelung_mit_Vorsteuerung_nichtlinear','StartTime','0','StopTime','10','FixedStep','1/1e5');
    ...
    filename = fullfile('./7. Reglervalidierung/5. Zustandsregelung_mit_Vorsteuerung_nichtlinear/', 'nichtlinear_referenzwertvorsteuerung.pdf');
